...
class ReportGenerator:
    ...
    def generate_markdown_report(self, state: SystemState,
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            # Header
            f.write("# GridOps Contingency Management Report\n\n")
    ...
    def generate_latex_report(self, state: SystemState,
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            ...
            f.write("constraint violations, which were addressed through automated multi-agent analysis ")
            f.write("and action planning. ")

            if state.get('selected_action'):
                f.write("A corrective action was identified with a safety score of ")
