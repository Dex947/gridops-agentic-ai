"""
Visualization for network analysis and reports.
"""
...
class NetworkVisualizer:
    """Generates matplotlib plots for voltage, loading, and topology."""
    ...
    def plot_line_loading(self, net: pp.pandapowerNet,
        ...
        colors = ['red' if load > thermal_limit else 'steelblue' for load in loadings]
