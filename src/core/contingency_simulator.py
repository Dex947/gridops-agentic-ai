"""
Contingency simulation module for GridOps Agentic AI System.
Simulates N-1, N-k contingencies and evaluates system response.
"""
...
class ContingencyType(Enum):
    """Types of contingencies to simulate."""
...
class ContingencyEvent:
    """Represents a single contingency event."""
...
class ContingencyResult:
    """Results from contingency simulation."""
...
class ContingencySimulator:
    """Simulate various contingency scenarios on distribution networks."""
    ...
    def generate_load_increase_scenarios(self, net: pp.pandapowerNet,
                                        increase_factors: List[float] = [1.2, 1.5, 2.0]) -> List[ContingencyEvent]:
        """
