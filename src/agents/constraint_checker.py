"""
Constraint Checker Agent - Validates thermal, voltage, and protection constraints.
"""
...
from src.core.state_manager import SystemState, ActionEvaluation
from src.config import NetworkConstraints


class ConstraintCheckerAgent:
    """
    Agent that validates network constraints and safety requirements.
    Ensures all proposed actions maintain system security.
    """
    ...
    def __init__(self, constraints: NetworkConstraints):
        ...
        Args:
            constraints: Network constraint definitions
        """
    ...
    def check_n_minus_1_security(self, net: pp.pandapowerNet) -> Dict[str, Any]:
        ...
        from src.core.contingency_simulator import ContingencySimulator, ContingencyType
        ...
        for i, contingency in enumerate(contingencies[:sample_size]):
